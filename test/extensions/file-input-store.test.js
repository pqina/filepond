...
describe('FileInputStore', () => {
    ...
    it('should add file to file input', (done) => {
    ...
    it('should add files to file input', (done) => {
    ...
    it('should not add files in failed state to file input', (done) => {
        input.addEventListener('update', () => {
    ...
    it('should update file input when file is edited', (done) => {
        const file = {
            src: new File(['hello world'], 'my-file.txt', { type: 'text/plain ' }),
            state: { store: true },
        };
