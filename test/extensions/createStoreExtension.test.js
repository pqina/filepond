...
describe('createStoreExtension', () => {
    ...
    it('should set "canStore" to "true" when "file" property set', (done) => {
        //
    ...
    it('should store a file when "store" set to "true"', (done) => {
        //
    ...
    it('should store a file when "shouldStore" is set to a function', (done) => {
    ...
    it('should abort store action when "store" set to "true" and "abort" set to "true"', (done) => {
        const StoreExtension = createStoreExtension('StoreExtension', {}, () => {
    ...
    it(`should set "canStore" to "false" if not storable`, (done) => {
        const unsub = entryTree.on('updateEntry', (entry) => {
    ...
    it(`shouldn't "store" an object when no value set`, (done) => {
        const unsub = entryTree.on('updateEntry', (entry) => {
            const { status, canStore } = entry?.extension?.StoreExtension || {};
    ...
    it(`should mark an object as stored if "value" is set`, (done) => {
        const unsub = entryTree.on('updateEntry', (entry) => {
            const { status, canStore } = entry?.extension?.StoreExtension || {};
    ...
    it(`should mark a file as stored if "value" is set`, (done) => {
        const unsub = entryTree.on('updateEntry', (entry) => {
            const {
                StoreExtension: { status, canStore },
            } = entry.extension;
    ...
    it(`should mark an object as stored if "value" is set, and retain "store" state`, (done) => {
        const unsub = entryTree.on('updateEntry', (entry) => {
            const { status, canStore } = entry?.extension?.StoreExtension || {};
    ...
    it(`should mark a file as stored if "value" is set, and retain "store" state`, (done) => {
        const unsub = entryTree.on('updateEntry', (entry) => {
            const {
                StoreExtension: { status, canStore },
            } = entry.extension;
    ...
    it('should restore the file object if "value" is set and "load" set to "true"', (done) => {
        const unsub = entryTree.on('updateEntry', (entry) => {
            const { status, canStore } = entry?.extension?.StoreExtension || {};
    ...
    it('should release the stored file when "store" is set to "false"', (done) => {
        const unsub = entryTree.on('updateEntry', (entry) => {
            const {
                StoreExtension: { status },
            } = entry.extension;
    ...
    it('should restore a file object and then release file when "store" set to "false" and currently is not a file', (done) => {
    ...
    it('should release a stored file when file data is updated', (done) => {
    ...
    it('should release file and store new file if "store" is "true" when file data is updated', (done) => {
    ...
    it('should release a stored file when file data is updated on an object', (done) => {
        let releasedFile = null;
