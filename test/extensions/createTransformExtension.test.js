...
describe('createTransformExtension', () => {
    ...
    it('should always transform a file object when no canTransformEntry set', () =>
        new Promise((done) => {
    ...
    it('should not transform file object when no file returned', () =>
        new Promise((done) => {
            let didCallTransformEntry = false;
    ...
    it('should transform file objects when action set to true', () =>
        new Promise((done) => {
            const unsub = entryTree.on('updateEntry', (entry) => {
                const {
    ...
    it('should restore file to original when action set to false', () =>
        new Promise((done) => {
            {
                const unsub = entryTree.on('updateEntry', (entry) => {
                    const {
    ...
    it('should correctly apply two file transforms in extension order', () =>
        new Promise((done) => {
            let transformOrder = [];
    ...
    it('should run auto-transforms in correct order', () =>
        new Promise((done) => {
            let transformState = {
                foo: 0,
                bar: 0,
    ...
    it('should re-run auto-transforms when a transform extension is reset', () =>
        new Promise((done) => {
            let transformState = {
                foo: 0,
                bar: 0,
