...
describe('taskScheduler', () => {
    ...
    it('should run task with parameters', (done) => {
        scheduler.pushTask(
            'entry-1',
            (a) => {
    ...
    it('should run task with parameters function', (done) => {
        scheduler.pushTask(
            'entry-1',
            (a) => {
                expect(a).to.be.equal('hello');
    ...
    it('should not run same tasks', (done) => {
    ...
    it('prevent run next task when a task returns false', (done) => {
        let tasks = [];
    ...
    it('prevent run next task when a task is aborted', (done) => {
    ...
    it('should take task priority option into account', (done) => {
        scheduler.on('error', done);
    ...
    it('should take task parallel option into account', (done) => {
        scheduler.on('error', done);
